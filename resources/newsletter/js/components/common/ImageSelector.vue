  ...
  <div class="image-selector">
    <div v-if="getImageUrl(selectedId)" class="selected-image">
      ...
      <div class="image-details">
        <button @click="openImageSelector" class="btn btn-sm btn-primary">Change Image</button>
        <button @click="clearImage" class="btn btn-sm btn-outline-danger">Clear</button>
      </div>
    </div>
    <button v-else @click="openImageSelector" class="btn btn-outline-primary">
      Select Image
    </button>
      ...
      <div class="image-selector-content">
        ...
        <div class="image-selector-body">
          ...
          <div v-if="hasMoreImages && !loading" class="load-more">
            <button @click="loadMoreImages" class="btn btn-outline-primary">Load More</button>
          </div>
        </div>

        <div class="image-selector-footer">
          <button @click="cancelImageSelection" class="btn btn-secondary">Cancel</button>
          <button @click="confirmImageSelection" class="btn btn-primary" :disabled="!tempSelectedId">Select</button>
        </div>
      </div>
    </div>
  </div>
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.success) {
            ...
            // Add the newly uploaded image to our image list and select it
            if (data.asset) {
              this.images.unshift(data.asset);
              this.filteredImages.unshift(data.asset);
