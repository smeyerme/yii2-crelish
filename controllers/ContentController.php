...
class ContentController extends Controller
{
  ...
  public function init()
  {
    ...
    $this->type = (!empty(\Yii::$app->getRequest()->getQueryParam('type'))) ? \Yii::$app->getRequest()->getQueryParam('type') : null;
    $this->uuid = (!empty(\Yii::$app->getRequest()->getQueryParam('uuid'))) ? \Yii::$app->getRequest()->getQueryParam('uuid') : null;

    if(empty($this->type)) {
      $this->type = (!empty(\Yii::$app->getRequest()->getQueryParam('cet'))) ? \Yii::$app->getRequest()->getQueryParam('cet') : 'page';
    }
